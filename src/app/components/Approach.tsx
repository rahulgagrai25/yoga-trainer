...
function Approach({}: ApproachProps) {
  ...
  useEffect(() => {
    ...
    // Animation for approach section
  ...
  return (
    <div ref={approachRef} className="py-16 md:py-24 bg-[#fcfaf8] relative z-10 overflow-hidden">
      <div className='elementl absolute top-[250px] left-[-250px] opacity-20 z-[-1]'>
        <img className='h-full w-auto rotate-90 max-sm:opacity-0' src="/line.png" alt="" />
      </div>
      <div className='elementl absolute top-[250px] right-[-250px] opacity-20 z-[-1]'>
        <img className='h-full w-auto rotate-270 max-sm:opacity-0' src="/line.png" alt="" />
      </div>
      <div className='elementp absolute top-[220px] left-[505px] opacity-30 z-[-1]'>
        <img className='h-full w-auto scale-[150%]' src="/yoga3.png" alt="" />
      </div>
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <h2 ref={approachHeadlineRef} className="text-3xl md:text-6xl font-light text-[#333] text-center mb-16 font-serif">My Approach</h2>
