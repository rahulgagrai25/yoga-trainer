    ...
    <section ref={sectionRef} className="bg-white relative overflow-hidden" id="about">
      ...
      <div className="py-16 md:py-24 relative">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 text-center relative z-10">
          <div className='elementp absolute opacity-25 left-[-40px] top-[-30px]'> <img src="/yoga.png" alt="" /></div>
          <h1
            ref={headlineRef}
          ...
          <p
            ref={subtextRef}
            className="text-xl text-[#555] max-w-3xl mx-auto font-sans"
          >
      ...
      <div className="min-h-screen w-full bg-white relative">
        ...
        <div className="py-16 md:py-24 relative z-10">
          <div className='palmleaf'>
            <img className='absolute h-[40%] w-auto left-[0px] bottom-[0px] z-30 max-sm:opacity-0' src="/palm2.png" alt="" />     
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center">
              ...
              <div ref={imageRef} className="w-full md:w-2/5">
                <div className="relative group">
                  <div className="absolute -inset-4 bg-[#ADf0E8] rounded-2xl -z-10 transform rotate-2 transition-all duration-500 group-hover:rotate-0 group-hover:bg-[#55D0C7]/20"></div>
              ...
              <div ref={contentRef} className="w-full md:w-3/5">
                <h2 ref={journeyHeadlineRef} className="text-3xl md:text-4xl font-light text-[#333] mb-6 font-serif">My Journey</h2>
                
                <div className="space-y-5 text-[#555] font-light font-sans">
